...
from app.chat.proactive_engine import ProactiveEngine
from app.chat.recommendation_engine import ChatRecommendationEngine
...
class ChatService:
    ...
    def get_history(self, user_id: str):
        ...
        from app.chat.schemas import ConversationHistoryResponse
